...
const Skills = () => {
    return (
        ...
        <h2 className='text-4xl text-start mb-8 text-bold px-8'>SKILLS</h2>
        <div className='grid grid-cols-2 gap-5 my-4 mx-8 md:px-8 md:py-8 md:grid-cols-3 md:justify-center md:border md:border-black md:border-solid'>
